...
public class FooWrapper implements Foo, ModelWrapper<Foo> {
	...
	@Override
	public int compareTo(com.liferay.sample.service.builder.model.Foo foo) {
	...
	*/
	...
	@Override
	public com.liferay.portal.model.CacheModel<com.liferay.sample.service.builder.model.Foo> toCacheModel() {
		return _foo.toCacheModel();
	}

	@Override
	public com.liferay.sample.service.builder.model.Foo toEscapedModel() {
	...
	@Override
	public com.liferay.sample.service.builder.model.Foo toUnescapedModel() {

...
package com.liferay.sample.service.builder.service.configuration.configurator;
 ...
 */
@Component(
	immediate = true, service = SampleServiceConfigurator.class
)
public class SampleServiceConfigurator {
	...
	protected ClassLoader getClassLoader() {
		Class<? extends SampleServiceConfigurator> clazz = getClass();

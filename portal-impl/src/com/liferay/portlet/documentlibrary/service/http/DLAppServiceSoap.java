...
public class DLAppServiceSoap {
	...
	* @throws RemoteException if the parent folder could not be found or if the
	...
	* @throws RemoteException if the parent folder or file entry could not be
	...
	* @param serviceContext the service context to be applied
	* @return the folder
	* @throws RemoteException if the source folder or the new parent folder
	...
	* @throws RemoteException if the file shortcut could not be found
	*/
	...
	* @throws RemoteException if the file version could not be found or invalid
	*/
	...
	* @throws RemoteException if the folder could not be found
	*/
	...
	* @throws RemoteException if the file name was invalid
	...
	* @throws RemoteException if the folder ould not be found
	*/
	...
	* @throws RemoteException if the parent folder could not be found
	*/
	...
	* @return the number of immediate subfolders and file entries across the
	folders
	* @throws RemoteException if the repository could not be found
	*/
	...
	* @throws RemoteException if the group could not be found
	*/
	...
	* @throws RemoteException if the repository or parent folder could not be
	found
	*/
	...
	* @throws RemoteException if the folder was invalid
	...
	* @param serviceContext the service context to be applied
	* @return the file entry
	* @throws RemoteException if the file entry or the new folder could not be
	found
	*/
	...
	* @param serviceContext the service context to be applied
	* @throws RemoteException if the file entry or version could not be found
	*/
	...
	* @param fileEntryTypeId the primary key of the file entry type
	* @throws RemoteException if the user or group could not be found, or if
	...
	* @param folderId the primary key of the folder
	* @param lockUuid the lock's UUID
	* @throws RemoteException if the repository or folder could not be found
	*/
	...
	* @param serviceContext the service context to be applied. Can set the
	...
	attributes for the file entry.
	* @return the file shortcut
	* @throws RemoteException if the file shortcut, folder, or file entry could
	not be found
	*/
	...
	* @return the folder
	* @throws RemoteException if the current or new parent folder could not be
